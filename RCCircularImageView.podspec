#
#  Be sure to run `pod spec lint RCCircularImageView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Ryan Collins" => "rccproductions@mac.com" }
  # Or just: s.author    = "Ryan Collins"
  # s.authors            = { "Ryan Collins" => "rccproductions@mac.com" }
  # s.social_media_url   = "http://twitter.com/Ryan Collins"
  ...
  s.source       = { :git => "http://github.com/ryanccollins/RCCircularImageView.git", :tag => "0.0.1" }
